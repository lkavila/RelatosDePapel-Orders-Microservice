...
| **POST** | `/api/v1/orders/user/{ownerId}` | Obtener listado de pedidos asociados a un id Cliente. | `CreateOrderResponseDto` (JSON con Comentarios, cantidades y fecha de Actualización) | `CreateOrderResponseDto` (HTTP 200 Ok)      |
